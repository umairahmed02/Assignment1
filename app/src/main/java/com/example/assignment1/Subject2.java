...
public class Subject2 extends AppCompatActivity {
    ...
    Query query = db.collection("Note").whereEqualTo("subject", "Subject2");
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                           ...
                                           public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                               ...
                                               for(int i = 0; i < task.getResult().getDocuments().size(); i++) {
                                                   ...
                                                   RecyclerViewAdapter adapter = new RecyclerViewAdapter(Subject2.this, noteArrayList);
                                                   recyclerView.setAdapter(adapter);
                                                   recyclerView.setLayoutManager(new LinearLayoutManager(Subject2.this));
                                               }
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Subject2.this, NoteEdit.class);
                intent.putExtra("Activity", "Subject2");
                startActivity(intent);
            }
        });
